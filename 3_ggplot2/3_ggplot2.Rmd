...
### `r icon("capsules")` [Multivariados](#Multi)
...
# `r icon("fish")` SEM plots (Gráficos de media)
...
# `r icon("map-marker-alt")` Mapas de coropletas
...
# `r icon("forward")` Regresión logística
